import ctypes
from ctypes import Structure, POINTER, c_double, c_int,c_char, c_float #Adicionar c_float para alterar TReg

class TReg(Structure): #Mudanca alterar elementos de TReg
...
lib.inserir_face.argtypes = [TReg]
lib.inserir_face.restype = None
